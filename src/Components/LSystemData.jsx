    ...
    return (
        <div className="grid grid-cols-2">
            <div className='grid grid-cols-2 sm:gap-4 p-1 col-span-2'>
                ...
                {rules.map((rule, i) => (
                    <div key={i} className='col-span-2 grid grid-cols-3 gap-4'>

                        <div class="relative w-full min-w-[100px]">
                            <textarea
                                ref={ruleRefs.current[i].key}
                                maxLength={1}
                                class="peer h-full bg-gray-200 min-h-[50px] w-full resize-none rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50"
                                placeholder=" ">
                            </textarea>
                            <label
            ...
            <div className='grid grid-cols-3 col-span-2 sm:p-1'>

                <div className="relative w-full min-w-[200px] h-10 col-span-2">
                    <input
                        ref={lengthRef}
                        type="number"
                        min={1}
